...
if __name__ == "__main__":
	...
	model_name = re.sub("google_bert", "google/bert", base_model.split("/")[-1])
	...
	bertSpeaker=BERTSpeakerID(base_model=model_name)
	bertSpeaker.load_state_dict(torch.load(base_model, map_location=device))
